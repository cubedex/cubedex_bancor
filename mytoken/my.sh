...
cleos set contract mytoken3 ../mytoken

cleos push action mytoken3 create '[eosio, "100000000.0000 CBT", 123]' -p mytoken2
cleos push action mytoken3 issue '[user, "100000000.0000 CBT", 123]' -p eosio
