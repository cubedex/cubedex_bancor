(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token6createEyNS_5assetE $_ZN5eosio5token8transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEEy)
 (memory $0 1)
 ...
 (data (i32.const 928) "cannot pass end iterator to modify\00")
 (data (i32.const 976) "cannot transfer to self\00")
 (data (i32.const 1008) "to account does not exist\00")
 (data (i32.const 1040) "unable to find key\00")
 (data (i32.const 1072) "must transfer positive quantity\00")
 (data (i32.const 1104) "no balance object found\00")
 (data (i32.const 1136) "overdrawn balance\00")
 (data (i32.const 1168) "attempt to subtract asset with different symbol\00")
 (data (i32.const 1216) "subtraction underflow\00")
 (data (i32.const 1248) "subtraction overflow\00")
 ...
 (data (i32.const 1456) "onerror\00")
 (data (i32.const 1472) "eosio\00")
 (data (i32.const 1488) "onerror action\'s are only valid from the \"eosio\" system account\00")
 ...
 (export "_ZN5eosio5token6unlockEyNS_11symbol_typeE" (func $_ZN5eosio5token6unlockEyNS_11symbol_typeE))
 ...
 (func $_ZN5eosio5token11sub_balanceEyNS_5assetE (param $0 i32) (param $1 i64) (param $2 i32)
  ...
  (call $_ZN5eosio5token6unlockEyNS_11symbol_typeE
   (get_local $0)
   (get_local $1)
   (tee_local $3
    (i64.load offset=8
 ...
 (func $_ZN5eosio5token6unlockEyNS_11symbol_typeE (param $0 i32) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
