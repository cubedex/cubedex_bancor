(module
 ...
 (table 5 5 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN3cbt3buyEyN5eosio5assetE $_ZN3cbt2hiEy $_ZN3cbt4sellEyN5eosio5assetE $_ZN3cbt6createEyN5eosio5assetES1_)
 (memory $0 1)
 ...
 (data (i32.const 336) "mytoken\00")
 (data (i32.const 352) "transfer\00")
 (data (i32.const 368) "mywallet\00")
 (data (i32.const 384) "send EOS to exchange\00")
 (data (i32.const 416) " >>>transfer eos to mywallet EOS: \00")
 (data (i32.const 464) "invalid symbol name\00")
 (data (i32.const 496) "cannot pass end iterator to modify\00")
 (data (i32.const 544) "eos_out must a positive amount\00")
 (data (i32.const 576) "eosio.token\00")
 (data (i32.const 592) "receive token from wallet\00")
 (data (i32.const 624) " >>>transfer token to payer CBT: \00")
 (data (i32.const 672) " >>>no CBTCORE\00")
 (data (i32.const 688) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 752) "eos_quant symbol must not be EOS\00")
 ...
 (data (i32.const 992) "invalid sell\00")
 (data (i32.const 1008) "invalid conversion\00")
 (data (i32.const 1040) "unexpected asset symbol input\00")
 ...
 (data (i32.const 1168) "token_out must a positive amount\00")
 (data (i32.const 1216) "eos_quant symbol must be EOS\00")
 (data (i32.const 1248) " >>>create eos_supply:\00")
 (data (i32.const 1280) " token_supply:\00")
 (data (i32.const 1296) "invalid eos_supply amount\00")
 (data (i32.const 1328) "invalid token_supply symbol\00")
 (data (i32.const 1360) " >>>transfer eos to mywallet\00")
 (data (i32.const 1392) "send CBT to exchange\00")
 (data (i32.const 1424) " >>>transfer token to mywallet\00")
 (data (i32.const 1456) " >>>create emplace:\00")
 (data (i32.const 1488) ">>>already exist:\00")
 (data (i32.const 1520) "token_supply symbol cannot be EOS\00")
 (data (i32.const 1568) "eos_supply symbol only support EOS\00")
 (data (i32.const 1616) "invalid token_supply amount\00")
 (data (i32.const 1648) "cannot create objects in table of another contract\00")
 (data (i32.const 1712) "Hello, \00")
 (data (i32.const 10128) "malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 10224) "\00\00\00\00\00\00\f0?\00\00\00\00\00\00\f8?")
 (data (i32.const 10240) "\00\00\00\00\00\00\00\00\06\d0\cfC\eb\fdL>")
 (data (i32.const 10256) "\00\00\00\00\00\00\00\00\00\00\00@\03\b8\e2?")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$13
   ...
   (drop
    (call $_ZN5eosio14execute_actionI3cbtS1_JyNS_5assetES2_EEEbPT_MT0_FvDpT1_E
     (i32.add
      (get_local $9)
      (i32.const 72)
     )
 ...
 (func $_ZN3cbt6createEyN5eosio5assetES1_ (type $FUNCSIG$vijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i64)
  ...
  (block $label$29
   ...
   (block $label$70
    (block $label$71
     ...
     (call $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE6modifyIZNS1_6createEyNS_5assetES5_EUlRT_E0_EEvRKS2_yOS6_
      (i32.add
       (get_local $12)
       (i32.const 16)
      )
    ...
    (call $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE7emplaceIZNS1_6createEyNS_5assetES5_EUlRT_E_EENS3_14const_iteratorEyOS6_
     (i32.add
      (get_local $12)
      (i32.const 64)
     )
 ...
 (func $_ZN5eosio14execute_actionI3cbtS1_JyNS_5assetES2_EEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i32)
 ...
 (func $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE6modifyIZNS1_6createEyNS_5assetES5_EUlRT_E0_EEvRKS2_yOS6_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (i32.store offset=4
   (i32.const 0)
 ...
 (func $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE7emplaceIZNS1_6createEyNS_5assetES5_EUlRT_E_EENS3_14const_iteratorEyOS6_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (drop
   (call $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE4itemC2IZNS3_7emplaceIZNS1_6createEyNS_5assetES7_EUlRT_E_EENS3_14const_iteratorEyOS8_EUlS9_E_EEPKS3_SC_
    (tee_local $3
     (call $_Znwj
      (i32.const 104)
     )
 ...
 (func $_ZN5eosio11multi_indexILy10497615196363685888EN3cbt14exchange_stateEJEE4itemC2IZNS3_7emplaceIZNS1_6createEyNS_5assetES7_EUlRT_E_EENS3_14const_iteratorEyOS8_EUlS9_E_EEPKS3_SC_ (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
